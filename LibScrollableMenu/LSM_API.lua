...
--		table headerIcon						table or function returning a table of signature { iconText = "path/to/textureName.dds", iconTint=ZO_ColorDef, width=number, height=number }: Icon shown as the header is collapsed (e.g. a magnifying glass to show you can expand it to get a search). Default value is nil. Height is capped at 32!
