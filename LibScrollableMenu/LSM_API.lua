...
--		string headerIcon						String or function returning a .dds texture path string: Icon shown as the header is collapsed (e.g. a magnifying glass to show you can expand it to get a search). Default value is nil
